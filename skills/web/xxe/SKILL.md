...
Read ~/docs/public-security-references/XXE Injection/Intruders/XXE_Fuzzing.txt
Read ~/docs/public-security-references/src/pentesting-web/xxe-xee-xml-external-entity.md
```
