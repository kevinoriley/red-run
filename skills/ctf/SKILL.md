...
name: red-run-ctf
description: >
  Agent-teams-based CTF orchestrator for red-run. Uses Claude Code agent teams
  for persistent teammates with peer-to-peer messaging. Invoke with /red-run-ctf.
  Do NOT auto-trigger — manual invocation only.
