...
if [[ "$config_warnings" -eq 0 ]]; then
    echo ""
    echo "Done! Before starting Claude Code, launch shell-server:"
    echo ""
    echo "  bash tools/shell-server/start.sh    # in a tmux pane"
    echo ""
    echo "  Then start Claude Code from this repo directory."
    echo ""
